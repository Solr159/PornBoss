...
func RegisterRoutes(router *gin.Engine) {
	...
	router.GET("/videos/:id/markers", listVideoMarkers)
	router.POST("/videos/:id/markers", createVideoMarker)
	router.PATCH("/videos/:id/markers/:markerId", patchVideoMarker)
	router.DELETE("/videos/:id/markers/:markerId", deleteVideoMarker)
	...
	router.POST("/collections/javs/add", addJavsToCollection)
	router.POST("/collections/javs/remove", removeJavsFromCollection)
	router.POST("/collections/:id/analyze", analyzeCollection)
