...
type JavIdolFavoriteGroupSummary = JavFavoriteGroupSummary

func ListJavIdolFavoriteGroups(ctx context.Context, directoryIDs []int64) ([]JavIdolFavoriteGroupSummary, error) {
	return ListJavFavoriteGroups(ctx, JavFavoriteEntityIdol, directoryIDs)
}

func CreateJavIdolFavoriteGroup(ctx context.Context, name string) (*models.JavFavoriteGroup, error) {
	return CreateJavFavoriteGroup(ctx, JavFavoriteEntityIdol, name)
}

func RenameJavIdolFavoriteGroup(ctx context.Context, id int64, name string) error {
	return RenameJavFavoriteGroup(ctx, JavFavoriteEntityIdol, id, name)
}

func DeleteJavIdolFavoriteGroup(ctx context.Context, id int64) error {
	return DeleteJavFavoriteGroup(ctx, JavFavoriteEntityIdol, id)
}

func ReorderJavIdolFavoriteGroups(ctx context.Context, groupIDs []int64) error {
	return ReorderJavFavoriteGroups(ctx, JavFavoriteEntityIdol, groupIDs)
}
...
func ReorderJavIdolFavoriteGroupIdols(ctx context.Context, groupID int64, idolIDs []int64) error {
	return ReorderJavFavoriteGroupItems(ctx, JavFavoriteEntityIdol, groupID, idolIDs)
}

func RemoveJavIdolFavoriteGroupIdols(ctx context.Context, groupID int64, idolIDs []int64) error {
	return RemoveJavFavoriteGroupItems(ctx, JavFavoriteEntityIdol, groupID, idolIDs)
}

func ListJavIdolFavoriteGroupIDs(ctx context.Context, idolID int64) ([]int64, error) {
	return ListJavFavoriteGroupIDs(ctx, JavFavoriteEntityIdol, idolID)
}

func ReplaceJavIdolFavoriteGroups(ctx context.Context, idolID int64, groupIDs []int64) error {
	return ReplaceJavFavoriteGroups(ctx, JavFavoriteEntityIdol, idolID, groupIDs)
}
