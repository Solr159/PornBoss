...
- 自带 ModernZ OSC 脚本，mpv 播放时默认使用更现代的播放器控制界面。
...
- 如果只想浏览部分硬盘或文件夹，可以在顶部目录下拉菜单或“目录管理”中勾选启用目录；未启用的目录所有内容会完全隐藏。
- 如需英文或中文 JAV 标题与标签，可在“全局设置” -> “JAV元数据”中切换元数据语言。
