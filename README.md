...
- [macOS-x86_64](https://github.com/Solr159/PornBoss/releases/download/v1.5.5/pornboss-v1.5.5-macos-x86_64.zip)（适用于 Intel 芯片的 macOS）
- [macOS-arm64](https://github.com/Solr159/PornBoss/releases/download/v1.5.5/pornboss-v1.5.5-macos-arm64.zip)（适用于 M 芯片的 macOS）
