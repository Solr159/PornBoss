...
Pornboss 是一个跨平台的本地web应用，提供全方位、全自动化的本地成人视频管理服务，尤其擅长日本AV的管理和检索。

Pornboss的浏览体验和 JavDb、JavBus、JavLibrary 类似，但在它们的基础之上做了优化和改进，追求的是更加直观、更加强大、更加友好的用户体验。

如果你不想折腾任何复杂工具和配置，只想简单导入之后就可以立刻浏览看片，Pornboss将是你的完美选择。
...
- [Windows](https://github.com/Solr159/PornBoss/releases/download/v1.6.0/pornboss-v1.6.0-windows-x86_64.zip)
- [Linux](https://github.com/Solr159/PornBoss/releases/download/v1.6.0/pornboss-v1.6.0-linux-x86_64.zip)
- [macOS-x86_64](https://github.com/Solr159/PornBoss/releases/download/v1.6.0/pornboss-v1.6.0-macos-x86_64.zip)（适用于 Intel 芯片的 macOS）
- [macOS-arm64](https://github.com/Solr159/PornBoss/releases/download/v1.6.0/pornboss-v1.6.0-macos-arm64.zip)（适用于 M 芯片的 macOS）

也可以前往 [Releases](https://github.com/Solr159/pornboss/releases) 页面查看所有版本。

### 2. 启动程序

- Windows：双击 `pornboss.exe`。首次运行可能会被 SmartScreen 阻止，点击“更多信息” -> “仍要运行”。
- macOS：打开终端运行 `pornboss.command`。
...
- 扫描任务会在后台持续运行，点击右上角按钮在视频模式和JAV模式之间切换查看扫描进度。
- JAV模式下的女优、厂商、系列等信息会逐渐自动补齐，请耐心等待。
...
- **全自动化托管式目录服务**：pornboss提供的是托管式的本地目录服务，一旦目录内容发生任何变化，所有的数据更新都会由pornboss自动完成，你可以认为pornboss维护的是目录内容的实时全量映射（数据更新需要时间，所以并非零延迟，但是能保证最终一致性）。
<br>
