...
- [macOS-x86_64](https://github.com/Solr159/JavBoss/releases/download/v1.8.0/javboss-v1.8.0-macos-x86_64.zip)（适用于 Intel 芯片的 macOS）
- [macOS-arm64](https://github.com/Solr159/JavBoss/releases/download/v1.8.0/javboss-v1.8.0-macos-arm64.zip)（适用于 M 芯片的 macOS）
