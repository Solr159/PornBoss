    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 px-4">
      <div className="w-full max-w-sm rounded-lg bg-white p-3 shadow-xl">
        ...
        <div className="space-y-2">
          ...
          <div className="text-sm font-medium text-gray-700">分页排序</div>
          <label
            htmlFor="sort-recent"
          ...
          >
            ...
            <div className="text-sm font-semibold">
              最近加入（默认）
              <span className="ml-2 text-xs font-normal text-gray-500">按创建时间倒序</span>
            </div>
          </label>
          <label
          ...
          >
            ...
            <div className="text-sm font-semibold">
              文件名
              <span className="ml-2 text-xs font-normal text-gray-500">按文件名排序</span>
            </div>
          </label>
          <label
          ...
          >
            ...
            <div className="text-sm font-semibold">
              时长（长→短）
              <span className="ml-2 text-xs font-normal text-gray-500">按视频时长降序</span>
            </div>
          </label>
          <label
          ...
          >
            ...
            <div className="text-sm font-semibold">
              播放次数（多→少）
              <span className="ml-2 text-xs font-normal text-gray-500">按播放次数降序</span>
            </div>
          </label>
        </div>
